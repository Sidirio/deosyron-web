      ...
      <section className="relative overflow-hidden border-b border-white/10">
       ...
       <div className="relative mx-auto max-w-7xl px-6 pt-12 pb-16 md:px-10 md:pt-16 md:pb-20">
          <div className="grid items-start gap-14 lg:grid-cols-2">
            <div>
              <div className="mb-6 inline-flex items-center rounded-full border border-cyan-400/30 bg-cyan-400/10 px-4 py-2 text-sm tracking-[0.2em] text-cyan-300 uppercase">
                DEOSYRON SL
              </div>
